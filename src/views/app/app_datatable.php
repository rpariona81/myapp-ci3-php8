<div class="row">
	<div class="col-12">
		<div class="card card-block card-stretch card-height border border-shadow">
			<div class="card-header d-flex justify-content-between border border-bottom-1">
				<div class="iq-header-title">
					<h4 class="card-title mb-0">App Dashboard</h4>
				</div>
				...
				<div class="mx-auto">
					<div class="mb-3">
						<div class="input-group mb-1">
							...
							<?= form_dropdown('role_select', 'Region', '', 'class="form-control col-3" id="role_select"'); ?>
							&nbsp;
							<?= form_dropdown('status_select', 'Cargo', '', 'class="form-control col-3" id="status_select"'); ?>
							&nbsp;
...
<script>
	$(document).ready(function() {
		...
		$.fn.dataTable.Buttons.defaults.dom.button.className = 'font-weight-bold btn btn-outline-info border-1';
		...
		var mytable = $("#datatable-buttons").DataTable({
			...
			//stateSave: true,
			language: {
				url: '<?= base_url('assets/libs/datatables.net/i18n/es-ES.json') ?>',
				paginate: {
					previous: "<<",
					next: ">>",
					first: "<",
