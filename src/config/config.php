...
/*
|--------------------------------------------------------------------------
| <?=base_url('assets/dashboard/')?>assetsr Logging Threshold
|--------------------------------------------------------------------------
|
| You can enable <?=base_url('assets/dashboard/')?>assetsr logging by setting a threshold over zero. The
| threshold determines what gets logged. Threshold options are:
|
|	0 = Disables logging, <?=base_url('assets/dashboard/')?>assetsr logging TURNED OFF
|	1 = <?=base_url('assets/dashboard/')?>assetsr Messages (including PHP <?=base_url('assets/dashboard/')?>assetsrs)
|	2 = Debug Messages
|	3 = Informational Messages
|	4 = All Messages
|
| You can also pass an array with threshold levels to show individual <?=base_url('assets/dashboard/')?>assetsr types
|
| 	array(2) = Debug Messages, without <?=base_url('assets/dashboard/')?>assetsr Messages
|
| For a live site you'll usually only enable <?=base_url('assets/dashboard/')?>assetsrs (1) to be logged otherwise
...
/*
|--------------------------------------------------------------------------
| <?=base_url('assets/dashboard/')?>assetsr Logging Directory Path
|--------------------------------------------------------------------------
|
...
/*
|--------------------------------------------------------------------------
| <?=base_url('assets/dashboard/')?>assetsr Views Directory Path
|--------------------------------------------------------------------------
|
| Leave this BLANK unless you would like to set something other than the default
